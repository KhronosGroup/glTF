...
//@ Jon: now refers to ToT master branch in github, rather than the local repository
...
where {chi}^+^(*x*) denotes the Heaviside function: 1 if *x* > 0 and 0 if *x* {leq} 0. See <<Heitz2014,Heitz (2014)>> for a derivation of the formulas.
