...
The global transformation matrix of a node is the product of its local transformation matrix and the local transformation matrices of all its parent nodes.
