...
image:figures/padding-mat2-1byte.png[pdfwidth=4in,align=left]

*MAT3, 1-byte components*

image:figures/padding-mat3-1byte.png[pdfwidth=4in,align=left]

*MAT3, 2-byte components*

image:figures/padding-mat3-2byte.png[pdfwidth=4in,align=left]
