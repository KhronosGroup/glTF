...
Any node **MAY** contain one mesh, defined in its `mesh` property. The mesh **MAY** be skinned using information provided in the referenced `skin` object. The mesh **MAY** have morph targets.
