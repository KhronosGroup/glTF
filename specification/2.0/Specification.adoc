...
- `a` be the aspect ratio (width over height) of the field of view;
- `y` be the vertical field of view in radians;
- `n` be the distance to the near clipping plane.
...
- `a` equals `camera.perspective.aspectRatio` or the aspect ratio of the current viewport;
...
- `a` be the aspect ratio (width over height) of the field of view;
- `y` be the vertical field of view in radians;
- `f` be the distance to the far clipping plane;
- `n` be the distance to the near clipping plane.
...
- `r` be half the orthographic width;
- `t` be half the orthographic height;
- `f` be the distance to the far clipping plane;
- `n` be the distance to the near clipping plane.
...
When `r / t` does not match the aspect ratio of the viewport, client implementations **SHOULD NOT** perform non-uniform scaling ("`stretching`") to fill the viewport.
