...
Files in this repository fall under one of these licenses:
  ...
  ** For specification source markup documents such as the glTF 2.0 asciidoc sources.
     The glTF 2.0 specification HTML and PDF *outputs* built from these
     sources are ratified and published in the
