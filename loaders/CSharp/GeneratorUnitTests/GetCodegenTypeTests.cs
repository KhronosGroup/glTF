...
namespace GeneratorUnitTests
{
    ...
    public class GetCodegenTypeTests
    {
        ...
        public void DictionaryOfStringsTest()
        {
            ...
            var result = CodeGenerator.GetCodegenType(schema, "DictionaryValueTypeIsString", out attributes, out defaultValue);
            Assert.IsTrue(result.BaseType.Contains("Dictionary"));
            Assert.AreEqual(typeof(string).ToString(), result.TypeArguments[0].BaseType);
        ...
        public void SingleObjectMultiTypeReturnObject()
        {
            ...
            var result = CodeGenerator.GetCodegenType(schema, "SingleObjectMultiTypeReturnObject", out attributes, out defaultValue);
        ...
        public void SingleObjectAnyTypeReturnObject()
        {
            ...
            var result = CodeGenerator.GetCodegenType(schema, "SingleObjectAnyTypeReturnObject", out attributes, out defaultValue);
            Assert.AreEqual(typeof(object).ToString(), result.BaseType);
        }
        ...
        public void SingleObjectIsReferenceTypeException()
        {
            ...
            schema.Type = new TypeReference[] { typeRef1 };
            Assert.Throws<NotImplementedException>(() => CodeGenerator.GetCodegenType(schema, "IsReferenceType", out attributes, out defaultValue));
        }
        ...
        public void SingleObjectCustomerTypeTest()
        {
            ...
            typeRef1.Name = "object";
            schema.Type = new TypeReference[] { typeRef1 };
            var result = CodeGenerator.GetCodegenType(schema, "SingleObjectCustomerType", out attributes, out defaultValue);
        ...
        public void SingleObjectCustomerTypeNoTitleException()
        {
            ...
            typeRef1.Name = "object";
            schema.Type = new TypeReference[] { typeRef1 };
            Assert.Throws<NotImplementedException>(() => CodeGenerator.GetCodegenType(schema, "SingleObjectCustomerTypeNoTitle", out attributes, out defaultValue));
        }
