...
| [Scapic](http://www.scapic.com/create/usdz/) | `FBX`, `STL`, `OBJ`, `DAE`, `GLTF` | ![status](https://img.shields.io/badge/glTF-2%2E0-green.svg?style=flat), `USDZ` | Easily convert models into a GLB or USDZ formats. View the converted file right in the browser before you download, or use the file to create an AR/VR experience all on the web and share it with a single link.|
