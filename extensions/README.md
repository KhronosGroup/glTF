...
1. Names MUST begin with an UPPERCASE prefix, followed by an underscore. Prefixes are `KHR` for [Khronos extensions](#ratified-khronos-extensions-for-gltf-2.0), `EXT` for [Multi-vendor extensions](#multi-vendor-extensions-for-gltf-2.0), and others may be reserved for [Vendor extensions](#vendor-extensions-for-gltf-2.0).
