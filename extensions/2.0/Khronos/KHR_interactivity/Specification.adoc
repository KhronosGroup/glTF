...
The `majorVersion` and `minorVersion` read-only properties nested in the `asset` path represent the major and minor version of the glTF asset. Values of these properties **MUST** exactly match the major and minor version numbers of the glTF asset.
