...
= Contributors
  ...
  * Steven Vergenz, Microsoft link:mailto:steven.vergenz@microsoft.com[steven.vergenz@microsoft.com]
...
= Known Implementations
  ...
  * https://github.com/KhronosGroup/UnityGLTF[UnityGLTF]
  * https://www.babylonjs.com/[Babylon.js]
  * https://playcanvas.com/[PlayCanvas]
  * https://threejs.org/[Three.js]
  * https://docs.blender.org/manual/en/2.81/addons/import_export/io_scene_gltf2.html#uv-mapping[Blender]
