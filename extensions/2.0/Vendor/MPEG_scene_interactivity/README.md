...
|**nodes**|`integer` `[1-*]`|Indices of the nodes in the nodes array to be considered. <br/>Required if type is ACTION_ACTIVATE, ACTION_TRANSFORM, ACTION_BLOCK, ACTION_MANIPULATE, CTION_SET_MATERIAL and ACTION_SET_HAPTIC.|No|
