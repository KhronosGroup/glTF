...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/unittest_debug_x32_gmake.exe
  DEFINES   += -DDEBUG
  INCLUDES  += -I../../include -I../../thirdparty/gtest/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -g -m32 -msse4.2
  CXXFLAGS  += $(CFLAGS) 
...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/unittest_release_x32_gmake.exe
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../../include -I../../thirdparty/gtest/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -O2 -m32 -msse4.2
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -s -m32 -L/usr/lib32 -L../../thirdparty/lib
...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/unittest_debug_x64_gmake.exe
  DEFINES   += -DDEBUG
  INCLUDES  += -I../../include -I../../thirdparty/gtest/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -g -m64 -msse4.2
  CXXFLAGS  += $(CFLAGS) 
...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/unittest_release_x64_gmake.exe
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../../include -I../../thirdparty/gtest/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -O2 -m64 -msse4.2
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -s -m64 -L/usr/lib64 -L../../thirdparty/lib
