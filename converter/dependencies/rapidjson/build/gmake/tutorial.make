...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_debug_x32_gmake.exe
  DEFINES   += -DDEBUG
  INCLUDES  += -I../../include
...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_release_x32_gmake.exe
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../../include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_debug_x64_gmake.exe
  DEFINES   += -DDEBUG
  INCLUDES  += -I../../include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_release_x64_gmake.exe
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../../include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
